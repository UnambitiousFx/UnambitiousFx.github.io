...
2. Read [Result](/lib-functional/result/) for railway-oriented pipelines.
3. Read [Maybe](/lib-functional/maybe/) for optional-value flows.
4. Read [Failures and Metadata](/lib-functional/failures-and-metadata) for error modeling and contextual data.
5. Read [ASP.NET Core](/lib-functional/aspnetcore/) for HTTP mapping and web API integration.
6. Read [xUnit](/lib-functional/xunit/) for assertion patterns in tests.
