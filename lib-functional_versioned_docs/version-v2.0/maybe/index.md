...
- [Result](/lib-functional/result/) - For operations that can fail with errors
- [Failures and Metadata](/lib-functional/failures-and-metadata) - For typed failure modeling and contextual metadata
